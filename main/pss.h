...
extern struct SubInfo* subinfo[];
extern struct TreeInfo* old[MG];
extern int m;
extern int p;
extern int noGroups;
extern int noSubs;
...
/**
 * @brief Function to find a subscriber in the subinfo struct from the id
 * 
 * @param id the id of the subscriber
 * 
 * @return a pointer to the subscriber, or null if the subscriber doesnt exist
*/
